...
def run(root, classes_file,save_path, batch_size=8, lr=0.00005):
    ...
    dataset = Dataset(root, "train",classes_file, transforms=train_transforms, normalize=False, sample=False, resize=False)
