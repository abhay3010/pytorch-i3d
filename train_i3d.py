...
def run(init_lr=0.1, max_steps=64e3, mode='rgb', root='/ssd/Charades_v1_rgb', train_file='tiny_train.json', test_file='tiny_test.json',labels_file="classes.txt", batch_size=8*5, save_model=''):
    # setup dataset
