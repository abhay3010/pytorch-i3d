opt = {
    ...
    "params":{
        "model_prefix":"resizer_spatial_2_56_", # the prefix used while training the model, 
        "epoch_list": range(6,51), # the epochs for which the model needs to be evaluated, currently epoch 3 and 10
        ...
        "num_resblocks": 2, # the number of residual blocks being used in the model
    }
