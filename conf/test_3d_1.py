opt = {
    "model":"resizer", 
    "params":{
        "model_prefix":"resizer_3d_3res_unfrozen_", # the prefix used while training the model, 
        "model_type":"2d",
        "epoch_list": range(3, 50), # the epochs for which the model needs to be evaluated, currently epoch 3 and 10
