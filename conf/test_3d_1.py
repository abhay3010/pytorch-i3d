opt = {
    "model":"resizer", 
    "params":{
        "model_prefix":"resizer_3d_1_unfrozen", # the prefix used while training the model, 
        "model_type":"3d",
        "epoch_list": range(1, 16), # the epochs for which the model needs to be evaluated, currently epoch 3 and 10
