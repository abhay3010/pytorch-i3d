opt = {
    ...
    "params":{
        "model_prefix":"resizer_spatial_2dcnn_before_skip_3res_", # the prefix used while training the model, 
        "epoch_list": range(18,23), # the epochs for which the model needs to be evaluated, currently epoch 3 and 10
        ...
        "confusion":"_corrected_after_2d_first_before_skip_3res.npy",
        "mode":"2d",
