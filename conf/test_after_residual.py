opt = {
    ...
    "params":{
        ...
        "epoch_list": range(12,26), # the epochs for which the model needs to be evaluated, currently epoch 3 and 10
        ...
        "confusion":"_corrected_after_2d_first_after_residual_skip_3res.npy",
        "mode":"2d",
