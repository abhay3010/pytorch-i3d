opt = {
    ...
    "save_path": "/virat-vr/models/pytorch-i3d/resizer_spatial_4_56_", # prefix of the model being trained. Saved after every epoch, with the epoch id added 
