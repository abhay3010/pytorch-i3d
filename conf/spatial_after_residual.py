opt = {
    ...
    "save_path": "/virat-vr-models/resizer_spatial_3dcnn_after_after_residual_", # prefix of the model being trained. Saved after every epoch, with the epoch id added 
