opt = {
    ...
    "params":{
        "model_prefix":"resizer_spatial_0_5_3res_", # the prefix used while training the model, 
        ...
        "batch_size": 72, # batch size of the evaluation block, will depend on the gpu 
        ...
        "confusion":"_corrected_after_0_5.npy",
        "mode":"2d",
        "read_at":0,
        "apply_at":5
