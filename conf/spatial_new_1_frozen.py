opt = {
    ...
    "params":{
        "model_prefix":"resizer_spatial_2dcnn_after_first_after_skip_scale_", # the prefix used while training the model, 
        "epoch_list": range(7, 50), # the epochs for which the model needs to be evaluated, currently epoch 3 and 10
        ...
        "batch_size": 8, # batch size of the evaluation block, will depend on the gpu 
