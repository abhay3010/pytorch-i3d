opt = {
    ...
    "params":{
        ...
        "epoch_list": range(0,33), # the epochs for which the model needs to be evaluated, currently epoch 3 and 10
        ...
        "confusion":"_corrected_after_2d_first_before_skip.npy",
        "mode":"2d",
