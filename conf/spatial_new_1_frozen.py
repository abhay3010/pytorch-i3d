opt = {
    ...
    "params":{
        "model_prefix":"resizer_spatial_corrected_1_56_after_first_first_frozen_", # the prefix used while training the model, 
        "epoch_list": range(2, 30), # the epochs for which the model needs to be evaluated, currently epoch 3 and 10
