opt = {
    ...
    "save_path": "/virat-vr/models/pytorch-i3d/resizer_spatial_1_56_first_unfrozen", # prefix of the model being trained. Saved after every epoch, with the epoch id added 
