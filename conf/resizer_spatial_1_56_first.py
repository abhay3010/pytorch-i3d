opt = {
    ...
    "save_path": "/virat-vr-models/resizer_spatial_1_56_first_twice_after_resize_", # prefix of the model being trained. Saved after every epoch, with the epoch id added 
