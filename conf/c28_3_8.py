opt = {
    ...
    "save_path": "/virat-vr-r-models/resizer_spatial_28_3_8_3res_", # prefix of the model being trained. Saved after every epoch, with the epoch id added 
    ...
    "batch_size":24, # the batch size to be used 
