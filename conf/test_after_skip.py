opt = {
    ...
    "params":{
        "model_prefix":"resizer_spatial_2dcnn_after_skip_3res_", # the prefix used while training the model, 
        "epoch_list": range(1,34), # the epochs for which the model needs to be evaluated, currently epoch 3 and 10
        ...
        "confusion":"_corrected_after_32_after_skip_3res.npy",
        "mode":"2d",
        "apply_at":"after_skip"
    }
