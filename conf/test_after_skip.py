opt = {
    ...
    "params":{
        ...
        "epoch_list": range(0,50), # the epochs for which the model needs to be evaluated, currently epoch 3 and 10
        ...
        "batch_size": 60, # batch size of the evaluation block, will depend on the gpu 
