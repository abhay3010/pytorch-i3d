opt = {
    ...
    "params":{
        "model_prefix":"resizer_spatial_3dcnn_before_skip_dual_", # the prefix used while training the model, 
        "epoch_list": range(2,12), # the epochs for which the model needs to be evaluated, currently epoch 3 and 10
        ...
        "confusion":"_corrected_after_3d_first_before_skip.npy",
        "mode":"2d",
