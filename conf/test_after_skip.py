opt = {
    ...
    "params":{
        "model_prefix":"resizer_spatial_2dcnn_after_residual_skip_3res_", # the prefix used while training the model, 
        "epoch_list": range(0,18), # the epochs for which the model needs to be evaluated, currently epoch 3 and 10
        ...
        "batch_size": 50, # batch size of the evaluation block, will depend on the gpu 
        ...
        "confusion":"_corrected_after_32_after_residual_skip_3res.npy",
        "mode":"2d",
        "apply_at":"after_residual_skip"
    }
