opt = {
    ...
    "save_path": "/virat-vr-models/resizer_spatial_3dcnn_after_residual_skip_dual_", # prefix of the model being trained. Saved after every epoch, with the epoch id added 
    ...
    "batch_size":42, # the batch size to be used 
