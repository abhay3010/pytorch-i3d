opt = {
    ...
    "params":{
        "model_prefix":"resizer_spatial_2_", # the prefix used while training the model, 
        "epoch_list": range(3,26), # the epochs for which the model needs to be evaluated, currently epoch 3 and 10
