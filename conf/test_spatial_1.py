opt = {
    ...
    "params":{
        "model_prefix":"resizer_spatial_3_", # the prefix used while training the model, 
        "epoch_list": range(6,30), # the epochs for which the model needs to be evaluated, currently epoch 3 and 10
