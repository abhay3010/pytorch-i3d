opt = {
    ...
    "save_path": "/virat-vr/models/pytorch-i3d/resizer_spatial_1_", # prefix of the model being trained. Saved after every epoch, with the epoch id added 
    ...
    "model_input_shape":28, # the shape that the i3d model expects from the resizer
    ...
    "batch_size":40, # the batch size to be used 
