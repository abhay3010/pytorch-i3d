opt = {
    ...
    "params":{
        "model_prefix":"resizer_spatial_1_56_first_unfrozen", # the prefix used while training the model, 
        "epoch_list": range(1, 40), # the epochs for which the model needs to be evaluated, currently epoch 3 and 10
