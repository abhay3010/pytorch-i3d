opt = {
    ...
    "params":{
        "model_prefix":"resizer_spatial_1_56_first_twice_after_resize_", # the prefix used while training the model, 
        "epoch_list": range(2, 25), # the epochs for which the model needs to be evaluated, currently epoch 3 and 10
        ...
        "confusion":"twice_after_resize.npy"
    }
