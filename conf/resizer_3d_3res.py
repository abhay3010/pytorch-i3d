opt = {
    ...
    "save_path": "/virat-vr-models/resizer_3d_3res_unfrozen_", # prefix of the model being trained. Saved after every epoch, with the epoch id added 
    ...
    "freeze_i3d":False, # set to True if we need to freeze all but the last layers of the i3d model, False if you want to train i3d with the resizer
