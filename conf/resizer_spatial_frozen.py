opt = {
    ...
    "save_path": "/virat-vr-models/resizer_spatial_3dcnn_after_first_last_scale_", # prefix of the model being trained. Saved after every epoch, with the epoch id added 
