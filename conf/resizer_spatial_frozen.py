opt = {
    ...
    "save_path": "/virat-vr-models/resizer_spatial_2dcnn_after_first_first_scale_", # prefix of the model being trained. Saved after every epoch, with the epoch id added 
