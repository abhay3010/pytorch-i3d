...
def run(data_root, model_input_shape, virat_model_path,batch_size,save_model='', init_lr = 0.001 ,num_epochs=10,v_mode='32x112', classes_file='classes.txt'):
    ...
    resizer = ResizerMainNetworkV4_2D(3, int(v_mode.split('x')[0]), model_input_shape,num_resblocks=2)
...
def main():
    ...
    batch_size = 32
    save_model = '/virat-vr/models/pytorch-i3d/resizerv42d_v2_32_28_2res_'
